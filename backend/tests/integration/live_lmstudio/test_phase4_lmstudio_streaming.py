"""
Live LM Studio Phase 4 SSE streaming tests.

WHAT: Test SSE streaming endpoint with real LM Studio provider
...
class TestLMStudioStreaming:
    """Test SSE streaming with LM Studio."""
    
    @pytest.mark.asyncio
    async def test_stream_connected_event(self, client, skip_if_no_lm_studio, sample_initialize_request):
    ...
    @pytest.mark.asyncio
    async def test_stream_event_ordering(self, client, skip_if_no_lm_studio, sample_initialize_request):
    ...
    @pytest.mark.asyncio
    async def test_stream_heartbeat_interval(self, client, skip_if_no_lm_studio, sample_initialize_request):
    ...
    @pytest.mark.asyncio
    async def test_stream_clean_close(self, client, skip_if_no_lm_studio, sample_initialize_request):
