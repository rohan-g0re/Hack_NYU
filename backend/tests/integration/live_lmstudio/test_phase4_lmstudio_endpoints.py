"""
Live LM Studio Phase 4 endpoint tests.

WHAT: Test Phase 4 API endpoints with real LM Studio provider
WHY: Validate API contract with live local inference provider
HOW: Use TestClient with LM Studio configured, skip if not available
"""
...
from tests.conftest import check_lm_studio_available
...
def sample_initialize_request():
    """Sample initialize session request optimized for LM Studio."""
    return {
        "buyer": {
            "name": "Test Buyer",
            "shopping_list": [
        ...
        "llm_config": {
            "model": os.getenv("LM_STUDIO_DEFAULT_MODEL", "qwen/qwen3-1.7b"),
...
@pytest.mark.slow
class TestLMStudioSimulationEndpoints:
    """Test simulation endpoints with LM Studio."""
    
    @pytest.mark.asyncio
    async def test_initialize_session_success(self, client, skip_if_no_lm_studio, sample_initialize_request):
    ...
    @pytest.mark.asyncio
    async def test_initialize_session_validation_error(self, client, skip_if_no_lm_studio):
    ...
    @pytest.mark.asyncio
    async def test_get_session_success(self, client, skip_if_no_lm_studio, sample_initialize_request):
    ...
    @pytest.mark.asyncio
    async def test_get_session_not_found(self, client, skip_if_no_lm_studio):
    ...
    @pytest.mark.asyncio
    async def test_delete_session_success(self, client, skip_if_no_lm_studio, sample_initialize_request):
    ...
    @pytest.mark.asyncio
    async def test_delete_session_not_found(self, client, skip_if_no_lm_studio):
    ...
    @pytest.mark.asyncio
    async def test_get_session_summary(self, client, skip_if_no_lm_studio, sample_initialize_request):
...
@pytest.mark.requires_lm_studio
@pytest.mark.slow
class TestLMStudioNegotiationEndpoints:
    """Test negotiation control endpoints with LM Studio."""
    
    @pytest.mark.asyncio
    async def test_start_negotiation_success(self, client, skip_if_no_lm_studio, sample_initialize_request):
    ...
    @pytest.mark.asyncio
    async def test_start_negotiation_not_found(self, client, skip_if_no_lm_studio):
    ...
    @pytest.mark.asyncio
    async def test_start_negotiation_already_active(self, client, skip_if_no_lm_studio, sample_initialize_request):
    ...
    @pytest.mark.asyncio
    async def test_send_message(self, client, skip_if_no_lm_studio, sample_initialize_request):
    ...
    @pytest.mark.asyncio
    async def test_get_negotiation_state(self, client, skip_if_no_lm_studio, sample_initialize_request):
    ...
    @pytest.mark.asyncio
    async def test_force_decision(self, client, skip_if_no_lm_studio, sample_initialize_request):
...
@pytest.mark.requires_lm_studio
@pytest.mark.slow
class TestLMStudioLogsEndpoint:
    """Test logs retrieval endpoint with LM Studio."""
    
    @pytest.mark.asyncio
    async def test_get_log_not_found(self, client, skip_if_no_lm_studio):
